...
Feudal rents paid in *bushels*. Bushels were a customary unit of measure that did not distinguish between volume and mass.
...
- Efforts at local standardisation - carve standardised bushel from stone, store in church.
...
- Rights to collect taxes from land are distributed among overlapping lines of authority.
...
- Trees and grazing areas were common, with local rules and regulations.
- No single person "owns" the land.

Translates to private ownership of land.

## Infrastructural Power and Private Ownership of Land

Begin with standard system of measurement
-> Conduct cadastral survey to establish fixed boundaries: Combination of principles of spatial measurement with knowledge of legal principles
-> Registration of boundaries
-> Annual assessment of property value
-> Annual collection of taxes
-> Police force to enforce property rights and judicial system to adjudicate disputes

**Cadastral survey**: Systematic partitioning of land with numbering system.

### The Apogee of Legibility

Land in the west of the US is more "rectangular"

## Projects of Legibility: Individuals, Language, and National Cultures

People: From customary, patronymic names to universal fixed surnames.

> *France*
> Imposition of a single, official language, replacing French as the trans-Europe language of elites, and local dialects.
> Teachers as state and nation builders.
...
- Increasing resources/capacities -> increasing weight of the state over society -> increasing territorial uniformity of the state.

### Unintended Consequences of State Building

- Prior to state building, political authority is locally circumscribed: With few exceptions, all politics were local politics, and all commerce was local as well.
- Therefore, people had no reason to identify with political bodies outside their local environment.
- But with projects of legibility and new burdens placed on local communities by voracious rules, politics slowly became "nationalised"
- Nations are relatively modern constructions: They are the ideational concomitant of this slow political development.

*People had no reason to identify with political bodies outside of local politics.*

*Nations require individuals to identify with identity. States do not.*

## Nations

> A community of people who recognise themselves as culturally distinct from other groups due to:
...
- Ideology that claims that a nation can achieve its common destiny only through mass cooperation via sovereign political institutions
- Two corollaries:
  - The borders of the state should be congruent with the borders of the nation
  - The state must represent the interests of the nation, not the interests of the ruler or dynasty or ruling class or any other particular group
